# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 20:22:23 2019
...
def check_goal_node(node,goalnode):
    if(node.nodex==goalnode.nodex and node.nodey==goalnode.nodey):#check goalnode reached
        return True
...
def a_algo(startx,starty,goalx,goaly,reso,r,c):
    show=True
...
def main():
    ...
    a,b, obs_x, obs_y, lx,ly =a_algo(startx,starty,goalx,goaly,reso,r,c)
    if show:
